...
extern "C" 
{
	...
	RetCode_t WINAPI XMS_acsSetMaster(ACSHandle_t acsHandle,DJ_U8 u8Master,PrivateData_t * privateData);
	...
	RetCode_t WINAPI XMS_ctsSendRawFrame(ACSHandle_t acsHandle,DeviceID_t * deviceID, DJ_U16 u16FrameSize,DJ_Void * pData);
	
	RetCode_t WINAPI XMS_ctsJoinTo3GVConf(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, 
						DeviceID_t * deviceID, Acs_MediaEx_Input_V* input, Acs_MediaEx_Output_V* output, 
						DJ_U8 u8Visible, PrivateData_t * privateData);
						
	RetCode_t WINAPI XMS_ctsLeaveFrom3GVConf(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, DeviceID_t * deviceID, PrivateData_t * privateData);
	
	RetCode_t WINAPI XMS_ctsClear3GVConf(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, PrivateData_t * privateData);
	
	RetCode_t WINAPI XMS_ctsGetLayout(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, PrivateData_t * privateData);
	
	RetCode_t WINAPI XMS_ctsSetLayout(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, Acs_3GVConf_LayoutList * layoutList, PrivateData_t * privateData);
	
	RetCode_t WINAPI XMS_ctsGetVisibleList(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, PrivateData_t * privateData);
	
	RetCode_t WINAPI XMS_ctsSetVisibleList(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, Acs_3GVConf_VisibleList * visableList, PrivateData_t * privateData);

	RetCode_t WINAPI XMS_ctsPutTextInPicture(ACSHandle_t acsHandle, DJ_S8 *s8DstFile, PutTextInPicture_Param *paramItem, DJ_U32 u32ParamSum, PrivateData_t * privateData);

	RetCode_t WINAPI XMS_ctsRestart3GVConf(ACSHandle_t acsHandle, DeviceID_t * device3GVConfID, PrivateData_t * privateData);

	RetCode_t WINAPI XMS_acsGetRelateMod(ACSHandle_t acsHandle,DJ_U8 u8ModType,DJ_U8 u8UnitID);
	
	RetCode_t WINAPI XMS_ctsPutUsrEvt(ACSHandle_t acsHandle,DeviceID_t * deviceID, UserEvt_Head_t * pUserEvt);

	RetCode_t WINAPI XMS_acsLedCtrl(ACSHandle_t acsHandle, DJ_U8 u8DspUnitID, UserLedCtrl * pLedCtrl);
